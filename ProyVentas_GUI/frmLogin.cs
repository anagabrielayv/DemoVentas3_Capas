    ...
    public partial class frmLogin : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            if(txtLogin .Text.Trim() != "" & txtPassword.Text.Trim() != "")
             {
                // Codifique...
                //Obtenemos las credenciales según el login
                ...
                {
                //Si el usuario existe, validamos su contraseña
                    if(txtLogin.Text == objUsuarioBE.Login_Usuario & txtPassword.Text == objUsuarioBE.Pass_Usuario)
                    {
                        //Las credenciales son correctas y se guardan en la clase estática clsCredenciales
                        this.Hide();
